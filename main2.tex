...
\textbf{Ubicación en la tesis:} Capítulo 3, especialmente las secciones ``Función del capítulo dentro de la tesis'', ``Requisitos computacionales de los casos de estudio'' y la Tabla de trazabilidad del capítulo.
}
...
\textbf{Ubicación en la tesis:} Capítulo 3 completo, con énfasis en las secciones ``Selección de plataformas de apropiación e implementación'', ``Flujo de implementación y comunicación CPU--FPGA'' y ``Cierre metodológico hacia la implementación BPM''.
}
